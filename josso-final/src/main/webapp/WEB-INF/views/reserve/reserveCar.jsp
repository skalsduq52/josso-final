    ...
    <style>
        ...
        <script>
            ...
            $(function(){
            	...
            	var itemNumberMain = ['#itemAvante','#itemBenz'];
            	tablePrint = $('.table_location').html();
            	$.ajax({
    				url : '/josso/userCarJSON',
    				dataType : 'json',
    				type : 'get',
    				success : function(Itemdata){
	    				...
	    				$(function(){
		    		    	$("#itemAvante").children().children('.user-name').each(function() {
	    				...
	    				$(function(){
		    		    	$("#itemBenz").children().children('.user-name').each(function() {
        ...
        <main>
            ...
            <div>
                <table class="table table-borderless">
                    ...
                    <tbody>
                        <tr>
                            <td style="font-size:15px">아반떼_그룹&josso</td>
                            <td>
                        ...
                        <tr>
                            <td style="font-size:15px">벤츠_그룹&josso</td>
                            <td>
