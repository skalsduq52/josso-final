...
<html>
    ...
    <style>
        ...
        <script>
            ...
            $(function(){
                $('.table-dialog > tr > td').click(function(){
                	var str = $(this).text();
        ...
        <div id="detail-dialog" style="display:none">
        	<div>
				...
				<div>
					<span>예약시간</span>
					<span>
						<input id="detail-time" type="text" readonly>
					</span>
				</div>
				<div>
					<span>예약자</span>
				...
				<div>
					<span>이용목적</span>
					<span><input id="detail-purpose"  type="text" readonly ></span>
				</div>
				<div>
					<input type="button" value="종료" id="cancle_dialog">
				</div>
			</div>   
        </div>
</body>
