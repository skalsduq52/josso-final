            ...
            <table class="table">
                <thead class="thead-dark text-left">
                    <tr>
                        ...
                        <input type="hidden" name="emailSend" value="${employee.employeeEmail}">                        </td>
                    </tr>
                    <tr>
                        <td>받는 사람  </td> 
                        <td colspan="2"><input type="email" autocomplete="off" placeholder="이름을 입력해주세요"  autofocus  id="emailAccept" class="inputEmail1 form-control form-control-sm ">
                        <input type="hidden" id="emailAccept-h" name="emailAccept" value="">
                        <div id="textarea1" class="listEmail1" style="display:none;"></div></td>
                    </tr>
                    <tr>
                        <td>참조  </td>
                        <td colspan="2"><input type="email" autocomplete="off" placeholder="이름을 입력해주세요"  autofocus  id="emailReference" class="inputEmail2 form-control form-control-sm ">
                    ...
                    <tr>
                        <td>제목  </td>
                        <td colspan="2"><input type="text" value="FW: ${sendDelivery.emailTitle}" name="emailTitle" class="form-control form-control-sm "></td>
                    </tr>
                    <tr>
                        <td>첨부파일  </td>
