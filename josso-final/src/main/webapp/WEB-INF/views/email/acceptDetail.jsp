            ...
            <div class="container-xl-fluid">
                ...
                <div class="row">
                    <div class="col nav-menu">
                        	<a href="/exam/email/accept/reply?num=${acceptDetail.emailNumber}"><input type="submit" class="btn btn-outline-info float-left" value="답장"></a>
	                        	<c:if test="${acceptDetail.emailRead eq 'NO'}">
		                        <a href="/exam/email/accept/read?num=${acceptDetail.emailNumber}"><input type="submit" class="btn btn-outline-info float-left" value="읽음"></a>
		                        </c:if>
		                        <c:if test="${acceptDetail.emailRead eq 'YES'}">
		                        <a href="/exam/email/accept/read?num=${acceptDetail.emailNumber}"><input type="submit" class="btn btn-outline-info float-left" value="안읽음"></a>
		                        </c:if>
	                        <a href="/exam/email/accept/delivery?num=${acceptDetail.emailNumber}"><input type="submit" class="btn btn-outline-info float-left" value="전달"></a>
	                        <a href="/exam/email/accept/wastebasket?num=${acceptDetail.emailNumber}"><input type="submit" class="btn btn-outline-info float-left" value="휴지통"></a>
                    </div>
                    <div class="col"></div>
                    <div class="col"></div>
                </div>
            ...
            <table class="table table-hover">
                <thead class="thead-dark text-left">
                    <tr>
                        ...
                        <td colspan="2">
                        <input type="email" class="form-control form-control-sm form-control-plaintext" readonly value="${acceptDetail.emailTitle}">
                        </td>
                    </tr>
                    <tr>
                        <td>보낸 사람  </td>
                    ...
                    <tr>
                        <td>보낸날짜  </td>
                        <td colspan="2"><input type="text" readonly value="<fmt:formatDate value="${acceptDetail.regDate}" pattern="yy-MM-dd [E] a hh:mm:ss"></fmt:formatDate>" class="form-control form-control-sm form-control-plaintext"></td>
                    </tr>
                    <tr>
                        <td>첨부파일  </td>
