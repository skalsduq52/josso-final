            ...
            <div class="container-xl-fluid">
                ...
                <div class="row">
                    <div class="col nav-menu">
                        <a href="/exam/email/send/delivery"><input type="submit" class="btn btn-outline-info float-left" value="전달"></a> 
                        <a href="/exam/email/send/wastebasket"><input type="submit" class="btn btn-outline-info float-left" value="휴지통"></a>
                    </div>
                    <div class="col"></div>
                    <div class="col"></div>
                </div>
                        ...
                        <tbody class="table table-borderless table-hover">
                            <c:forEach var="n" items="${sendList}">
								<tr>
	                                ...
	                                <td>${n.emailAccept}</td>
	                                <td><a href="/exam/email/send/detail?num=${n.emailNumber}">${n.emailTitle}</a></td>
