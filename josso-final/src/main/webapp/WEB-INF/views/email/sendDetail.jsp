        ...
        <main>
            ...
            <table class="table table-hover">
                <thead class="thead-dark text-left">
                    ...
                    <tr>
                        <td>보낸날짜  </td>
                        <td colspan="2"><input type="text" readonly value="<fmt:formatDate value="${sendDetail.regDate}" pattern="yy-MM-dd [E] a hh:mm:ss"></fmt:formatDate>" class="form-control form-control-sm "></td>
                    </tr>
                    <tr>
                        <td>첨부파일  </td>
