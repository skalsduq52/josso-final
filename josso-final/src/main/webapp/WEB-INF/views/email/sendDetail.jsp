            ...
            <table class="table table-hover">
                <thead class="thead-dark text-left">
                    <tr>
                        ...
                        <td colspan="2">
                        <input type="email" class="form-control form-control-sm " readonly value="${sendDetail.emailTitle}">
                        </td>
                    </tr>
                    <tr>
                        <td>보낸 사람  </td>
                    ...
                    <tr>
                        <td>보낸날짜  </td>
                        <td colspan="2"><input type="text" readonly value="<fmt:formatDate value="${sendDetail.regDate}" pattern="yyyy년 MM월 dd일 hh시 mm분 ss초"></fmt:formatDate>" class="form-control form-control-sm "></td>
                    </tr>
                    <tr>
                        <td>첨부파일  </td>
