            ...
            <div class="container-xl-fluid">
                ...
                <div class="row">
                    <div class="col nav-menu">
                        <a href="/exam/email/wastebasket/restoration?num=${wastebasketDetail.emailNumber}"><input type="submit" class="btn btn-outline-info float-left" value="복구"></a>  
                        <a href="/exam/email/wastebasket/delete?num=${wastebasketDetail.emailNumber}"><input type="submit" class="btn btn-outline-info float-left" value="삭제"></a>
                    </div>
                    <div class="col"></div>
                    <div class="col"></div>
                </div>
        ...
        <main>
            ...
            <table class="table table-hover">
                <thead class="thead-dark text-left">
                    ...
                    <tr>
                        <td>보낸 사람  </td>
                        <td colspan="2"><input type="email" readonly value="${wastebasketDetail.emailSend}" class="form-control form-control-sm form-control-plaintext"></td>
                    </tr>
                    <tr>
                        <td>받는 사람</td>
                        <td colspan="2"><input type="email" readonly value="${wastebasketDetail.emailAccept}" class="form-control form-control-sm form-control-plaintext"></td>
                    </tr>
                    <tr>
                        <td>참조</td>
                        <td colspan="2"><input type="text" readonly value="${wastebasketDetail.emailReference}"class="form-control form-control-sm form-control-plaintext"></td>
                    </tr>
                    <tr>
                        <td>보낸날짜  </td>
