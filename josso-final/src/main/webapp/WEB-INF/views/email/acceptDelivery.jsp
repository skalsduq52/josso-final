        ...
        <main>
            ...
            <table class="table">
                <thead class="thead-dark text-left">
                    ...
                    <tr>
                        <td>받는 사람  </td>
                        <td colspan="2"><input type="text" placeholder="이름을 입력해주세요"  autocomplete="off" autofocus  id="emailAccept" class="inputEmail1 form-control form-control-sm">
                        <input type="hidden" id="emailAccept-h" name="emailAccept" value="">
                        <div id="textarea1" class="listEmail1" style="display:none;"></div></td>
                    </tr>
                    <tr>
                        <td>참조  </td>
                        <td colspan="2"><input type="text" placeholder="이름을 입력해주세요"  autocomplete="off" autofocus id="emailReference" class="inputEmail2 form-control form-control-sm">
