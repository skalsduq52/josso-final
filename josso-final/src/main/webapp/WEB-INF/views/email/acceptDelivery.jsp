            ...
            <table class="table table-hover">
                <thead class="thead-dark text-left">
                    <tr>
                        ...
                        <input type="email"  autocomplete="off" autofocus readonly value="${employee.employeeEmail}" name="emailSend" class="form-control form-control-sm">
                        </td>
                    </tr>
                    <tr>
                        <td>받는 사람  </td>
                        <td colspan="2"><input type="email" placeholder="이름을 입력해주세요"  autocomplete="off" autofocus  id="emailAccept" name="emailAccept" class="inputEmail1 form-control form-control-sm">
                        <div id="textarea1" class="listEmail1" style="display:none;"></div></td>
                    </tr>
                    <tr>
                        <td>참조  </td>
                        <td colspan="2"><input type="email" placeholder="이름을 입력해주세요"  autocomplete="off" autofocus id="emailReference" name="emailReference"class="inputEmail2 form-control form-control-sm">
                        <div id="textarea2" class="listEmail2" style="display:none;"></div></td>
                    </tr>
                    <tr>
                        <td>제목  </td>
                        <td colspan="2"><input type="text" value="FW: ${acceptDelivery.emailTitle}" name="emailTitle" class="form-control form-control-sm"></td>
                    </tr>
                    <tr>
                        <td>첨부파일  </td>
...
-----Original Message-----
From: <${acceptDelivery.emailSend}>
To: 이름/부서/직급 <${acceptDelivery.emailAccept }>
Cc:
Sent: <fmt:formatDate value="${acceptDelivery.regDate}" pattern="yy-MM-dd [E] a hh:mm:ss"></fmt:formatDate>
Subject: ${acceptDelivery.emailTitle}

${acceptDelivery.emailContent}
