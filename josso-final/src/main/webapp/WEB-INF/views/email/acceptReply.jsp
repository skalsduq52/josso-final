            ...
            <div class="container-xl-fluid">
                ...
                <div class="row">
                    <div class="col nav-menu">
                        <a href="/exam/email/accept/replySend"><input type="submit" class="btn btn-outline-info float-left" value="보내기"></a> 
                        <a href="/exam/email/accept/reply?num=${acceptReply.emailNumber}"><input type="submit" class="btn btn-outline-info float-left" value="다시쓰기"></a>
                    </div>
                    <div class="col"></div>
                    <div class="col"></div>
                </div>
        ...
        <main>
            ...
            <table class="table table-hover">
                <thead class="thead-dark text-left">
                    ...
                    <tr>
                        <td>받는 사람  </td>
                        <td colspan="2"><input type="email" value="${acceptReply.emailSend}" name="emailAccept" class="form-control form-control-sm form-control-plaintext"></td>
                    </tr>
                    <tr>
                        <td>참조  </td>
                    ...
                    <tr>
                        <td>제목  </td>
                        <td colspan="2"><input type="text" value="RE: ${acceptReply.emailTitle}" name="emailTitle" class="form-control form-control-sm form-control-plaintext"></td>
                    </tr>
                    <tr>
                        <td>첨부파일  </td>
