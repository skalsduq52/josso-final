            ...
            <div class="container-fluid">
                <div>
                    <table class="table" style="text-align: center; border: 1px solid #dddddd">
                        ...
                        <thead>
                            <tr>
                                <td class="send-list-title" style="width: 10%;"><input type="checkbox" id="allCk" name="allCk"></th>
                                <td class="send-list-title" style="width: 20%;">보낸 사람</th>
                                <td class="send-list-title" style="width: 45%;">제목</th>
                                <td class="send-list-title" style="width: 25%;">작성일</th>
                            </tr>
                        </thead>
