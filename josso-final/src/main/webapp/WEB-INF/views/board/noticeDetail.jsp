                ...
                <table style="width: 100%; height:500px" id="board">
                    <thead>
                        <tr class="left_tr border-bottom"> 
                            ...
                            <td colspan="3" class="right_td" style="padding-top:20px"><span>${noticeBoard.boardTitle}</span></td><br>
                        </tr>
                        <tr class="border-bottom" style="height: 50px;">
                            ...
                            <c:if test="${empty noticeBoard.boardFile}">
	                        	첨부파일 없음.
	                        </c:if> <c:if test="${not empty noticeBoard.boardFile}">
                    ...
                    <tbody>
                        <tr id="write_content" class="border-bottom">
                            ...
                            <td colspan="3" class="right_td"><div id="smartEditor" style="height: 400px; width: 100%;">${noticeBoard.boardContent}</div></td>
                        </tr>
                    </tbody>    
                </table>
            </div>
