...
public class ReportPaging {
	...
	// 매개변수 생성자
	public ReportPaging(String reportTitle, String employeeName, int page, String title, String query, int count, int startNum, int lastNum,
	...
	public String toString() {
		return "BoardPaging [boardTitle=" + reportTitle + ", employeeName=" + employeeName + ", page=" + page
